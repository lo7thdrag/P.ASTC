...
const
  ...
  //vhdAmphibious = 4;        vhdsAmphibious  = 'Amphibious';
  vhdGeneral    = 4;        vhdsGeneral     = 'General';
...
type
  ...
  E_OverlayInputState = (oisStart, oisEnd);
...
////====================================================
  ...
  TRecHelicopter_Land_Launch_Limits =  record
    ...
    Max_Turn_Rate_To_Launch      : single;
    Max_Turn_Rate_To_Land        : single;
    Max_Landing_Altitude         : single;
    Max_Relative_Speed           : single;
