...
uses uDataModuleTTT,uSimDBEditor,ufrmResorceAllocationPickList,uDBAssetObject,ufrmMissileOnBoardPickList,
ufrmSummaryResourceAllocation,uDBAsset_Weapon,ufrmTorpedoOnBoardPickList,uSonobuoySelect, ufrmMineOnBoardPickList,
uSatelliteSelect;
...
//    3: dmTTT.updatePlatformInstance(rec,StrToInt(lbTempPI.Items.Strings[cbbPI.ItemIndex]),-1,-1,-1,-1,-1,StrToInt(fSonobuoySelect.sonobuoy_id));
