...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, ComCtrls, uBlindZoneView, uDBBlind_Zone, tttData;
...
type
  ...
  private
    FOnBoardType : E_BlindZoneCaller;
  ...
  public
    ...
    property OnBoardType : E_BlindZoneCaller read FOnBoardType write FOnBoardType;
...
uses
  uDataModuleTTT, ufrmRadarMount, ufrmSonarMount, ufrmESMMount, ufrmElectroOpticalMount,
  ufrmVisualDetectorMount,
  ufrmMissileMount, ufrmTorpedoMounts, ufrmGunMount,
  uDBAsset_Radar, uDBAsset_Sonar, uDBAsset_Sensor, uDBAsset_Weapon;


{$REGION ' Form Handle '}

procedure TBlindZonesAttachmentForm.FormCreate(Sender: TObject);
begin
...
procedure TBlindZonesAttachmentForm.FormShow(Sender: TObject);
begin
  UpdateBlindZoneForm;
...
procedure TBlindZonesAttachmentForm.btnOKClick(Sender: TObject);
begin
...
procedure TBlindZonesAttachmentForm.btnApplyClick(Sender: TObject);
begin
...
procedure TBlindZonesAttachmentForm.btnCancelClick(Sender: TObject);
begin
  Close;
end;

procedure TBlindZonesAttachmentForm.cbFirstBlindZoneClick(Sender: TObject);
begin
...
procedure TBlindZonesAttachmentForm.cbSecondBlindZoneClick(Sender: TObject);
begin
...
procedure TBlindZonesAttachmentForm.edtGeneralChange(Sender: TObject);
begin
...
procedure TBlindZonesAttachmentForm.FirstRotWheelDegreeChange(Sender: TObject);
var
  zs : TZoneSector;
begin
...
function TBlindZonesAttachmentForm.GetBlindZoneAngleWidth(const aDegStart,aDegEnd: Double): Integer;
begin
...
function TBlindZonesAttachmentForm.GetBlindZoneCentre(const aDegStart,aDegEnd: Double): Integer;
var
  width : Integer;
begin
...
procedure TBlindZonesAttachmentForm.SecondRotWheelDegreeChange(Sender: TObject);
var
  zs : TZoneSector;
begin
...
procedure TBlindZonesAttachmentForm.trckbrGeneralChange(Sender: TObject);
var
  d, e: double;
  zs: TZoneSector;
...
procedure TBlindZonesAttachmentForm.UpdateBlindZoneForm;
var
  zs : TZoneSector;
begin
  case FOnBoardType of
