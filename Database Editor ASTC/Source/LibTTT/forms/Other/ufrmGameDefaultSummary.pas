...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, ComCtrls, Mask, uDBGame_Defaults,
...
uses
  uDataModuleTTT, ufrmEffectsTable, ufrmIFFMode, uLibSettingTTT, tttData,
  newClassASTT;
...
begin
  ...
  begin
    ...
    edtAutoGunInterceptRange.Text := FormatFloat('0.000', value);
    btnApply.Enabled := True;
  end;
end;
...
begin
  ...
  begin
    ...
    edtAutoGunThresholdSpeed.Text := FormatFloat('0.0', value);
    btnApply.Enabled := True;
  end;
end;
...
begin
  ...
  begin
    ...
    edtDetectionHF.Text := FormatFloat('0.000', value);
    btnApply.Enabled := True;
  end;
end;
...
begin
  ...
  begin
    ...
    edtDetectionUHF.Text := FormatFloat('0.000', value);
    btnApply.Enabled := True;
  end;
end;
...
begin
  ...
  begin
    ...
    edtESMBearingErrorRate.Text := FormatFloat('0.0', value);
    btnApply.Enabled := True;
  end;
end;
...
begin
  ...
  if Key = #13 then
  begin
    value := StrToFloat(edtSinuationAmplitude.Text);
    edtSinuationAmplitude.Text := FormatFloat('0.0', value);
    btnApply.Enabled := True;
  end;
end;
...
begin
  ...
  begin
    ...
    edtMissileHAFOMaxRange.Text := FormatFloat('0.000', value);
    btnApply.Enabled := True;
  end;
end;
...
begin
  ...
  begin
    ...
    edtMissileHAFOMinRange.Text := FormatFloat('0.000', value);
    btnApply.Enabled := True;
  end;
end;
...
begin
  ...
  begin
    ...
    edtProbabilityDecreaseRate.Text := FormatFloat('0.000', value);
    btnApply.Enabled := True;
  end;
end;
...
begin
  ...
  begin
    ...
    edtProbabilityModifier.Text := FormatFloat('0.0', value);
    btnApply.Enabled := True;
  end;
end;
...
begin
  ...
  if Key = #13 then
  begin
    value := StrToFloat(edtSonarTMABearing.Text);
    edtSonarTMABearing.Text := FormatFloat('0.0', value);
    btnApply.Enabled := True;
  end;
end;
...
begin
  ...
  begin
    ...
    edtSonarTMAMaxCourseError.Text := FormatFloat('0.00', value);
    btnApply.Enabled := True;
  end;
end;
...
begin
  ...
  begin
    ...
    edtSonarTMASeduction.Text := FormatFloat('0.000', value);
    btnApply.Enabled := True;
  end;
end;
...
begin
  ...
  begin
    ...
    edtVisualCrossSection.Text := FormatFloat('0.00', value);
    btnApply.Enabled := True;
  end;
end;
