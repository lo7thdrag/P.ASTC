...
function TTorpedoLauncherForm.CekInput: Boolean;
begin
  Result := False;
...
procedure TTorpedoLauncherForm.UpdateLauncherData;
begin
  with FSelectedLauncher.FData do
  begin
...
function TTorpedoLauncherForm.GetNumberOfKoma(s: string): Boolean;
var
  a, i : Integer;
begin
  Result := False;
...
procedure TTorpedoLauncherForm.edtNumeralKeyPress(Sender: TObject; var Key: Char);
var
  value : Double;
begin
...
procedure TTorpedoLauncherForm.chkAngleRequiredClick(Sender: TObject);
begin
...
procedure TTorpedoLauncherForm.ComboBoxDataChange(Sender: TObject);
begin
...
procedure TTorpedoLauncherForm.edtAngleKeyPress(Sender: TObject; var Key: Char);
var
  value : Integer;
begin
...
procedure TTorpedoLauncherForm.edtChange(Sender: TObject);
begin
  btnApply.Enabled := True;
end;

procedure TTorpedoLauncherForm.ValidationFormatInput;
var
  i: Integer;
  value : Double;
