...
uses
  ...
  Dialogs, StdCtrls, ComCtrls, ExtCtrls, uDBAsset_Vehicle, uDBAsset_Weapon,  Vcl.Mask,
...
uses
  ...
  uMissileLaunchers, ufrmMissileOnBoardPickList, ufrmMineOnBoardPickList;
...
begin
  ...
  begin
    ...
    LastName := edtName.Text;
    edtClassName.Text := FMine_Def.Mine_Identifier;
