...
var
  frmRadarCoverage: TfrmRadarCoverage;
...
procedure TfrmRadarCoverage.btnCancelClick(Sender: TObject);
begin
  AfterClose := False;
  Close;
end;

procedure TfrmRadarCoverage.btnDeleteClick(Sender: TObject);
var
  i : Integer;
  data : TObject;
begin
...
procedure TfrmRadarCoverage.imgGraphMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var
...
procedure TfrmRadarCoverage.imgGraphMouseMove(Sender: TObject; Shift: TShiftState; X, Y: Integer);
var
...
procedure TfrmRadarCoverage.imgGraphMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var
...
procedure TfrmRadarCoverage.edtRangeMaxKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
  begin
...
procedure TfrmRadarCoverage.edtRangeMinKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
  begin
...
procedure TfrmRadarCoverage.edtElevationMaxKeyPress(Sender: TObject;   var Key: Char);
begin
  if Key = #13 then
  begin
...
procedure TfrmRadarCoverage.edtElevationMinKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
  begin
...
procedure TfrmRadarCoverage.ClearCanvas;
begin
...
procedure TfrmRadarCoverage.DrawGrid;
var
  i,
  tempX, tempY,
...
procedure TfrmRadarCoverage.DrawPoint;
var
...
procedure TfrmRadarCoverage.ConvertPositionToValue(const aX, aY: Integer; var aRange, aElevation: Double);
var
  posPercent : Double;
begin
