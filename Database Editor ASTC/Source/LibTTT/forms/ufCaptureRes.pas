...
uses ufrmLandmassEditor,Printers;

{$R *.dfm}

procedure TfCaptureRes.btnCaptureClick(Sender: TObject);
begin
  frmLandmassEditor.isCapturingScreen := true;
  recapture := true;
end;
...
begin
 ...
 begin
   imgCaptureResult.Picture.SaveToFile(SavePictureDialog1.FileName + '.jpg');
 end;

end;

procedure TfCaptureRes.btOKClick(Sender: TObject);
begin
     Close;
end;
