...
type
  ...
  public
    ...
    property SelectedRadarJammer : TJammer_On_Board read FSelectedRadarJammer write FSelectedRadarJammer;
  end;
...
uses
  uDataModuleTTT, ufrmSummaryVehicle, ufrmAvailableVehicle,
  uVehicleSelect, ufrmRadarJammerOnBoardPickList;
