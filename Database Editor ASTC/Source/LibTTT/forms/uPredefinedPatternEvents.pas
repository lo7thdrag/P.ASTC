...
//var I : Integer;
begin
//  dmTTT.getAllRadar_On_Board(fPredefinedPattern.pattern.FData.Vehicle_Index,0,radarList);
...
//var I : Integer;
begin
//   dmTTT.getAllSonar_On_Board(fPredefinedPattern.pattern.FData.Vehicle_Index,0,sonarList);
...
begin
//  dmTTT.getAllMissile_OnBoard(fPredefinedPattern.pattern.FData.Vehicle_Index,0,missileList);
...
//  end;
//
//  dmTTT.getAllTorpedo_OnBoard(fPredefinedPattern.pattern.FData.Vehicle_Index,0,torpedoList);
...
//  end;
//
//  dmTTT.getAllMines_OnBoard(fPredefinedPattern.pattern.FData.Vehicle_Index,0,minesList);
...
//  end;
//
//  dmTTT.GetGun_OnBoard(fPredefinedPattern.pattern.FData.Vehicle_Index,gunList);
...
//var I : Integer;
begin
//  dmTTT.getAllJammer_On_Board(fPredefinedPattern.pattern.FData.Vehicle_Index, jammerList);
...
//  begin
//      jammerName.Text := (TJammer_On_Board(jammerList[i]).FData.Instance_Identifier);
//  end;
end;
...
//var I : Integer;
begin
//  dmTTT.getAllIFF_Sensor_On_Board(fPredefinedPattern.pattern.FData.Vehicle_Index,0,iffList);
