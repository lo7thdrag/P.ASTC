...
type
  TMissileLaunchersForm = class(TForm)
    ...
    tsGeneral: TTabSheet;
    txtMaxQuantity: TStaticText;
    edtMaxQuantity: TEdit;
    chkAngleRequired: TCheckBox;
    grpAngle: TGroupBox;
    txtAngle: TStaticText;
    edtAngle: TEdit;
    pnlAction: TPanel;
    btnOK: TButton;
    btnCancel: TButton;
...
function TMissileLaunchersForm.CekInput: Boolean;
begin
  Result := False;
...
procedure TMissileLaunchersForm.UpdateLauncherData;
begin
  with FSelectedLauncher.FData do
  begin
...
function TMissileLaunchersForm.GetNumberOfKoma(s: string): Boolean;
var
  a, i : Integer;
begin
  Result := False;
...
procedure TMissileLaunchersForm.edtNumeralKeyPress(Sender: TObject; var Key: Char);
var
  value : Double;
begin
...
procedure TMissileLaunchersForm.chkAngleRequiredClick(Sender: TObject);
begin
  grpAngle.Enabled := chkAngleRequired.Checked;
...
procedure TMissileLaunchersForm.ComboBoxDataChange(Sender: TObject);
begin
...
procedure TMissileLaunchersForm.edtAngleKeyPress(Sender: TObject; var Key: Char);
var
  value : Integer;
begin
...
procedure TMissileLaunchersForm.edtChange(Sender: TObject);
begin
  btnApply.Enabled := True;
end;

procedure TMissileLaunchersForm.ValidationFormatInput;
var
  i: Integer;
  value : Double;
