...
type
  ...
  private
    ...
    procedure CopyProbabilityOfHit(idBomb : integer);
...
procedure TfrmAvailableBomb.CopyProbabilityOfHit(idBomb: integer);
var
  i : Integer;
  PointList : TList;
...
begin
  ...
  begin
    ...
    if dmTTT.GetBombPOHvsRange(idBomb, PointList) > 0 then
    begin
