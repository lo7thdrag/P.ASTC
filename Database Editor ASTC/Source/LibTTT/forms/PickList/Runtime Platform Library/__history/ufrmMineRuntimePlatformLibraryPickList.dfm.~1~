object frmMineRuntimePlatformLibraryPickList: TfrmMineRuntimePlatformLibraryPickList
  Left = 0
  Top = 0
  BorderIcons = []
  BorderStyle = bsToolWindow
  Caption = 'Mine Runtime Platform Library PickList'
  ClientHeight = 396
  ClientWidth = 621
  Color = clBtnShadow
