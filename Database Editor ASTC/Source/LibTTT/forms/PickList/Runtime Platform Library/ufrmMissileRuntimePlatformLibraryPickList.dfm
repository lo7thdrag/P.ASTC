object frmMissileRuntimePlatformLibraryPickList: TfrmMissileRuntimePlatformLibraryPickList
  Left = 0
  Top = 0
  BorderIcons = []
  BorderStyle = bsToolWindow
  Caption = '   Missile RPL Pick List'
  ClientHeight = 395
  ClientWidth = 621
  Color = clBtnShadow
  ...
  object pnlMain: TPanel
    ...
    object Label2: TLabel
      ...
      Height = 14
      Cursor = crHandPoint
      Caption = 'List of Missile On RPL'
      Color = clBtnShadow
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -12
    ...
    object lbAllMissileOnRPL: TListBox
      Left = 347
      Top = 41
      Width = 257
      Height = 286
      ItemHeight = 14
      TabOrder = 3
      OnClick = lbAllMissileOnRPLClick
