object frmOverlayRAPickList: TfrmOverlayRAPickList
  Left = 0
  Top = 0
  BorderIcons = []
  ...
  object pnlMain: TPanel
    ...
    object Label1: TLabel
      ...
      Height = 14
      Cursor = crHandPoint
      Caption = 'List of available Overlay Selection'
      Color = clHighlight
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -12
    ...
    object Label2: TLabel
      ...
      Height = 14
      Cursor = crHandPoint
      Caption = 'List of Overlay On Resource Allocation'
      Color = clHighlight
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -12
    ...
    object lbOverlayAvailable: TListBox
      ...
      ItemHeight = 14
      TabOrder = 2
      OnClick = lbOverlayAvailableClick
