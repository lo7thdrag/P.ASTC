...
uses
  uDataModuleTTT, uDBAsset_Weapon, Math,
  ufrmVektorMapGameCenterEditor, uScrCapture, ufCaptureRes, ufrmSummarySonar, ufrmSummaryTorpedo;
  ...
  case FProbabilityGraph of
    ...
    begin
      ...
      begin
        ...
        dmTTT.GetGunPOHvsRange(Gun_Index, Ord(FProbabilityGraph),
          FProbabilityPointList);
      end;
    end;
    pgBomb:
    begin
      ...
      begin
        ...
        dmTTT.GetBombPOHvsRange(Bomb_Index, FProbabilityPointList);
      end;
    end;
    pgSNRvsPOD:
    begin
      ...
      begin
        ...
        dmTTT.GetPODvsSNRCurvePoint(Curve_Definition_Index,
          FProbabilityPointList);
      end;
    end;
  end;
...
procedure TProbabilityGraph.DrawPoint;
var
    ...
    begin
      ...
      case FProbabilityGraph of
        ...
        begin
          with TTorpedo_On_Board(data).FTorpedo_POH do
          begin
            if (Aspect_Angle < FAspectMin) or (Aspect_Angle > FAspectMax) or
              ((POH_Modifier * 100) < FProbabilityMin) or ((POH_Modifier * 100) > FProbabilityMax) then
              Continue;
...
procedure TProbabilityGraph.UpdateProbabilityGraphForm;
begin
  ...
  begin
    case FProbabilityGraph of
      ...
      begin
        ...
        begin
          lblSelectedAspect.Caption := FormatFloat('0', Aspect_Angle);
          lblSelectedProbability.Caption := FormatFloat('0', POH_Modifier * 100);
        end;
      end;
      pgMine:
      begin
  ...
  begin
    ...
    case FProbabilityGraph of
      ...
      begin
        ...
        with TTorpedo_On_Board(FSelectedPoint).FTorpedo_POH do
        begin
//          Torpedo_Index := TTorpedo_On_Board(FSelectedProbObj).FTorpedo_POH.Torpedo_Index;
