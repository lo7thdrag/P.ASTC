unit ufrmSummaryGameAreaENC;

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, StdCtrls, OleCtrls, MapXLib_TLB, ExtCtrls, CheckLst,
  uDBAsset_GameEnvironment, ImgList, ComCtrls, ToolWin, uCoordConvertor, Types,
...
var
  frmSummaryGameAreaENC: TfrmSummaryGameAreaENC;

implementation

uses
  uMapXHandler, uDataModuleTTT, uDBEditSetting, ufrmAvailableGameArea,
  ufrmSummaryGameAreaVektor, uBaseCoordSystem;
...
procedure TfrmSummaryGameAreaENC.btnMultiSelectClick(Sender: TObject);
begin
  UpAllToolbarButton;
...
procedure TfrmSummaryGameAreaENC.btnCenterHookClick(Sender: TObject);
begin
  UpAllToolbarButton;
...
procedure TfrmSummaryGameAreaENC.ENCmapMapViewChanged(Sender: TObject);
var
  tempZoom : double;
begin
...
procedure TfrmSummaryGameAreaENC.ENCmapMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  i : Integer;
  layer : CMapXLayer;
