object frmFloatingDecoyOnBoardPickList: TfrmFloatingDecoyOnBoardPickList
  Left = 0
  Top = 0
  BorderIcons = []
  BorderStyle = bsToolWindow
  Caption = '   Floating Decoy On Board'
  ClientHeight = 408
  ClientWidth = 754
  Color = clBtnShadow
  ...
  object pnlMain: TPanel
    ...
    object Label1: TLabel
      ...
      Height = 14
      Cursor = crHandPoint
      Caption = 'List of available Floating Decoy'
      Color = clHighlight
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -12
    ...
    object Label2: TLabel
      ...
      Height = 14
      Cursor = crHandPoint
      Caption = 'List of Floating Decoy On Board'
      Color = clHighlight
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -12
    ...
    object lbAllFloatingDecoyDef: TListBox
      ...
      ItemHeight = 14
      TabOrder = 3
      OnClick = lbAllFloatingDecoyDefClick
      OnDblClick = btnAddClick
    end
    object lbAllFloatingDecoyOnBoard: TListBox
      Left = 430
      Top = 44
      Width = 313
      Height = 286
      ItemHeight = 14
      TabOrder = 4
      OnClick = lbAllFloatingDecoyOnBoardClick
