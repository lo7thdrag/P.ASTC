object frmInfraredDecoyOnBoardPickList: TfrmInfraredDecoyOnBoardPickList
  Left = 0
  Top = 0
  BorderIcons = []
  BorderStyle = bsToolWindow
  Caption = '   Infrared Decoy On Board'
  ClientHeight = 426
  ClientWidth = 621
  Color = clBtnShadow
  ...
  object pnlMain: TPanel
    ...
    object Label1: TLabel
      ...
      Height = 14
      Cursor = crHandPoint
      Caption = 'List of available Infrared Decoy'
      Color = clHighlight
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -12
    ...
    object Label2: TLabel
      ...
      Height = 14
      Cursor = crHandPoint
      Caption = 'List of Infrared Decoy On Board'
      Color = clHighlight
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -12
    ...
    object lbAllInfraredDecoyDef: TListBox
      Left = 8
      Top = 41
      Width = 257
      Height = 286
      ItemHeight = 14
      TabOrder = 3
      OnClick = lbAllInfraredDecoyDefClick
      OnDblClick = btnAddClick
    end
    object lbAllInfraredDecoyOnBoard: TListBox
      Left = 347
      Top = 41
      Width = 257
      Height = 286
      ...
      OnDblClick = btnEditSelectedClick
    end
  end
