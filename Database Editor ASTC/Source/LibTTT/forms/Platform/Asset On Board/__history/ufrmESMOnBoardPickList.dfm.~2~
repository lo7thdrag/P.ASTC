object frmESMOnBoardPickList: TfrmESMOnBoardPickList
  Left = 0
  Top = 0
  BorderIcons = []
  BorderStyle = bsToolWindow
  Caption = 'ESM On Board'
  ClientHeight = 426
  ClientWidth = 621
  Color = clBtnShadow
  ...
  object pnlMain: TPanel
    ...
    object lbAllESMDef: TListBox
      ...
      ItemHeight = 14
      TabOrder = 0
      OnClick = lbAllESMDefClick
      OnDblClick = btnAddClick
    end
    object lbAllESMOnBoard: TListBox
      Left = 347
      Top = 41
      Width = 257
      Height = 286
