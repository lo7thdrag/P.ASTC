...
//            OverlayEditorForm.edtEllipsePosLatt.Text  := formatDM_latitude(ellipsePosCenterLatitude);
//            OverlayEditorForm.edtEllipseGridLong.Text := ellipseGridPointCenterLongitude;
//            OverlayEditorForm.edtEllipseGridLatt.Text := ellipseGridPointCenterLatitude;
//            OverlayEditorForm.edtMajorAxis.Text       := inttostr(ellipseMajor);
//            OverlayEditorForm.edtMinorAxis.Text       := inttostr(ellipseMinor);
//            OverlayEditorForm.gbEllipse.BringToFront;
            break;
          end;
        end;
      end;
...
//            OverlayEditorForm.edtTextGridLong.Text := textGridStartLongitude;
//            OverlayEditorForm.edtTextGridLat.Text  := textGridStartLatitude;
//            OverlayEditorForm.edtText.Text         := TextString;
//            OverlayEditorForm.gbText.BringToFront;
            break;
          end;
        end;
      end;                  //end with
