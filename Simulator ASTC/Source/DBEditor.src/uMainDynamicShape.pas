...
procedure TEllipseDynamic.DrawRotatedEllipse(canvas: TCanvas; rec: TRect;
  degrees: integer);
const
  //Magic constant = 2/3*(sqrt(2)-1)
  offset1: single = 0.27614237;
var
...
begin
  ...
  begin
    ...
    begin
      ...
      offx := round((right - left) * offset1);
      offy := round((bottom - top) * offset1);
...
//    MoveTo(Iex, Iey); LineTo(osx, osy);
//    MoveTo(osx, osy); LineTo(Oex, Oey);
//    MoveTo(Oex, Oey); LineTo(Isx, Isy);
  end;
