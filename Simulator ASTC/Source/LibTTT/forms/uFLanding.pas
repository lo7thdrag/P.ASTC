  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if not (Abs(ControlledPlatform.Heading - HeadingTmp) < 30) then
        begin
...
procedure TfrmLanding.FormActivate(Sender: TObject);
begin
  AlphaBlend := True;
  AlphaBlendValue := 230;
end;
...
procedure TfrmLanding.FormDeactivate(Sender: TObject);
begin
  AlphaBlend := True;
  AlphaBlendValue := 200;
end;
