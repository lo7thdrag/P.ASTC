...
procedure TfrmMergeTracks.FormActivate(Sender: TObject);
begin
  AlphaBlend := True;
  AlphaBlendValue := 230;
end;
...
procedure TfrmMergeTracks.FormDeactivate(Sender: TObject);
begin
  AlphaBlend := True;
  AlphaBlendValue := 200;
end;
...
begin
  frmTacticalDisplay.ToolBtnHookPreviousClick(Sender);
  btHitClick(Sender);
end;

procedure TfrmMergeTracks.Button3Click(Sender: TObject);
begin
  frmTacticalDisplay.ToolBtnHookNextClick(Sender);
  btHitClick(Sender);
end;
