...
uses
  ...
  uDBAsset_Vehicle, uGameData_TTT, uT3Vehicle;
...
//        btnNext.Enabled := False;
    ...
    1 :
      begin
        ...
        RecToSend.InitCourse := FPlatformInst.Course ;
...
procedure TfrmLaunchPlaform.FormActivate(Sender: TObject);
begin
  AlphaBlend := True;
  AlphaBlendValue := 230;
end;
...
procedure TfrmLaunchPlaform.FormDeactivate(Sender: TObject);
begin
  AlphaBlend := True;
  AlphaBlendValue := 200;
end;
