...
type
  ...
  private
    ...
    FCycleUpdateAltitude    : double; {dlm second}
...
begin
  ...
  if Assigned(FBombDefinition) then begin
    with FBombDefinition do begin

      {Masuk tipe bomb apa}
      case FData.Bomb_Type of
        1 : TipeBomb := btBomb;
        2 : TipeBomb := btDepthCharge;
      end;
          ...
          begin
            ...
            begin
              ...
              if FSalvo <= 10 then
                ...
                OnHit(Self,pf,Round(Lethality*(FSalvo/10)));
              exit;
            end;
          end
          else
          begin
            ...
            begin
              ...
              if FSalvo <= 10 then
                ...
                OnHit(Self,pf,Round(Lethality*(FSalvo/10)), False);
            end;
            j := j + 1;
          end;
        end
...
//  FTacticalSymbol.Symbol.LoadBitmap(vSymbolSetting.ImgPath + 'GroundZero.bmp',color);
