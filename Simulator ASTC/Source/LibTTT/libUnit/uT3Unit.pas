...
begin
  ...
  if Assigned(OnLogEventStr) then
    OnLogEventStr('TT3Unit.SetInstanceIndex', 'InstanceName : ' + InstanceName + ' ; InstanceIndex : ' + IntToStr(InstanceIndex));
end;
...
begin
  ...
  end else FEnduranceType := entUnlimited;
...
begin
    ...
    FPIData            := ss.FData ;
    if Assigned(UnitMotion) then UnitMotion.FData   := ss.UnitMotion ;
