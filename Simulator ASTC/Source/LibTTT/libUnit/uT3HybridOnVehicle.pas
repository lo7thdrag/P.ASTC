...
begin
  ...
  dmTTT.GetMotion_Characteristics(FHybridDefinition.FMissile_Def.Motion_Index,FMissileMotion);
  dmTTT.GetMotion_Characteristics(FHybridDefinition.FTorpedo_Def.Motion_Index,FTorpedoMotion);
