...
begin
  ...
  FTacticalSymbol.TextVisual.Text := FNameRBLW;
...
begin
  ...
  FTacticalSymbol.TextVisual.Text := FNameBOLW;
  FTacticalSymbol.TextVisual.Center := Point(tBOLWPointX, tBOLWPointY);
  FTacticalSymbol.Color := clRed;
  FTacticalSymbol.Draw(aCnv);
end;
