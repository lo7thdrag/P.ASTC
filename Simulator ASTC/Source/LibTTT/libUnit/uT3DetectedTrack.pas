...
type
  ...
  public
    ...
    function IsDetectedOnlyByDataLink : Boolean;overload;
    function IsDetectedOnlyByDataLink(var datalink : TT3Datalink) : Boolean;overload;
...
uses
  ...
  uT3Missile, uDataTypes, uT3Radar, uT3Weapon,
  uT3Visual, uFilter;
...
begin
  ...
  filterType := TPictureFilterType(TrackDomain + 1);
        ...
        begin
          ...
          begin
            if (not(FTrackDomain = vhdAir)) then
              symbol := vSymbolSetting.ImgPath + getDetectedSymbolFileName(99,     //saya isi 99 biar beda sendiri>>untuk detect IFF, andik
              FTrackIdent)
            else
              symbol := vSymbolSetting.ImgPath + getDetectedSymbolFileName(FTrackDomain,
              FTrackIdent);
          ...
          begin
            ...
            begin
              ...
              begin
                FTacticalSymbol.TextVisual.Color := RGB(0,0,51);
                FTacticalSymbol.Color := RGB(0,0,51);
                FCountDetectTime := 0;
              end
              else
              begin
                FTacticalSymbol.TextVisual.Color := getColorFromIdentity(piPending);  //--- edit farid 20042012
...
function TT3DetectedTrack.IsDetectedOnlyByDataLink(
  var datalink: TT3Datalink): Boolean;
var
  obj : TSimObject;
  I: Integer;
begin
...
begin
  FTrackNumber := Value;
  FTacticalSymbol.TextVisual.Text := Format('%4d', [Value]);
end;
