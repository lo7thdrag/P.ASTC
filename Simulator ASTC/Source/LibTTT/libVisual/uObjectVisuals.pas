...
//------------------------------------------------------------------------------
  ...
  public
    ...
    property TextVisual     : TTextVisual  read FText write FText;
...
//    MoveTo(rDraw.Left, rDraw.Top);
//    LineTo(rDraw.Right, rDraw.Top);
//    LineTo(rDraw.Right, rDraw.Bottom);
//    LineTo(rDraw.Left, rDraw.Bottom);
//    LineTo(rDraw.Left, rDraw.Top);
  end;
...
begin
  ...
  begin
    ...
    DrawRectFrameWithoutbsClear(aCanvas, FRects);
...
//  inherited;
  ...
  tesRect.Create (FCenter);
  tesRect.Inflate(12, 8);
...
//      Rectangle(FSymbol.Center.X - w,FSymbol.Center.Y - h,FSymbol.Center.X
//          + w,FSymbol.Center.Y + h );

      rDraw := Rect(FSymbol.Center.X - w,FSymbol.Center.Y - h,FSymbol.Center.X
          + w,FSymbol.Center.Y + h );
...
//      Brush.Style := bsClear;
      ...
      rDraw.Left := FSymbol.Center.X - w;
      rDraw.Top  := FSymbol.Center.Y - h;
      rDraw.Right:= FSymbol.Center.X + w;
      rDraw.Bottom := FSymbol.Center.Y + h;
...
//      Rectangle(FSymbol.Center.X - w,FSymbol.Center.Y + h,FSymbol.Center.X - w
//                + 4,FSymbol.Center.Y + h + 4 );
      rDraw := Rect(FSymbol.Center.X - w,FSymbol.Center.Y + h,FSymbol.Center.X - w
                      + 4,FSymbol.Center.Y + h + 4  );
  ...
  if vFilter.Show(pftNone, 'Main symbol', 'Track symbol') then
