...
uses
  ...
  uSnapshotGCRec in '..\tttReplay\uSnapshotGCRec.pas',
  uSnapshotGCData in '..\tttReplay\uSnapshotGCData.pas',
  ...
  Vcl.Themes,
  Vcl.Styles,
  uDMGC in '..\GameController\uDMGC.pas' {DMGC: TDataModule},
  ufAudioTrackSetting in '..\GameController\ufAudioTrackSetting.pas' {frmAudioTrackSetting},
  ufConnectTerminate in '..\GameController\ufConnectTerminate.pas' {frmConnectTerminate},
  ufMainGC in '..\GameController\ufMainGC.pas' {frmMainGC},
  ufStartExerciseWizard in '..\GameController\ufStartExerciseWizard.pas' {frmStartExerciseWizard},
  ufStartReplayRecorded in '..\GameController\ufStartReplayRecorded.pas' {frmStartReplayRecorded},
  ufStartSession in '..\GameController\ufStartSession.pas' {frmStartSession},
  ufrmRoleSetting in '..\GameController\ufrmRoleSetting.pas' {frmRoleSetting};
