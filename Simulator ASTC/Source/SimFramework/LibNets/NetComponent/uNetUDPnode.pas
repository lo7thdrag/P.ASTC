...
type
  ...
  private
    FAddrIn  : OverbyteIcsWinSock.TSockAddrIn;
    FAddrSize: integer;
...
var pSize   : word;
    Dest    : OverbyteIcsWinSock.TSockAddr;
    DestLen : Integer;
    sInt    : LongWord;
    err : Integer;
begin
...
//  CopyMemory(@WinaddrIn,@FAddrIn, SizeOf(FAddrIn));

  recSize := Pointer(FBuffer);
//  senderIP := inet_ntoa(WinaddrIn.sin_addr);
  senderIP := WSocket_inet_ntoa(FAddrIn.sin_addr);
