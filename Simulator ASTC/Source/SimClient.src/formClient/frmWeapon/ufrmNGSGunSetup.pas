...
procedure TfrmNGSGunSetup.FormActivate(Sender: TObject);
begin
  AlphaBlend := True;
  AlphaBlendValue := 230;
end;
...
procedure TfrmNGSGunSetup.FormDeactivate(Sender: TObject);
begin
  AlphaBlend := True;
  AlphaBlendValue := 200;
end;
...
begin
  ...
  edtAimPoint.Text := formatDM_longitude(FMapPositionX) + '  '
