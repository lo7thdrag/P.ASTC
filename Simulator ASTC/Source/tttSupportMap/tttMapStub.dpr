...
begin
  MyMsg := RegisterWindowMessage('TTTMapStub_Message');
  Mutex := CreateMutex(nil, True, 'TTTMapStub_Mutex');
  ...
  begin
    ...
    Application.MessageBox('Another MapStub has already running.',
      'TTT Map Stub', MB_OK + MB_ICONINFORMATION);
    ...
    Application.Title := 'TTT Map Stub';
